...
public class UITest {
    ...
    @Test
    public void CountCoursesInQASectionTest() {
        ...
        log.info("Проверили, что выбран чекбокс Тестирование");
        new CourseFilterComponent(driver)
                .checkСourseFilterComponent(CategoryData.TESTING, true);
        log.info("Проверили отображение курсов и их количество");
    ...
    public void CourseInfoTest() {
        ...
        log.info("Проверили информацию о курсе");
    ...
    public void EventsDateTest() {
        ...
        log.info("Проверили отображение карточек и дату мероприятий");
    ...
    public void SortEventsTest() {
        ...
        headerSubMenuPopup.popupShouldBeVisible(HeaderMenuItemData.LEARNING)
                .clickSubMenuItemCoursesName(SubMenuCategoryCourseItemData.LESSON_CALENDAR, MenuCategory.EVENTS_CALENDAR);
        log.info("Выставили фильтр Открытый вебинар");
        new EventsCatalog(driver)
                .sortEvents(EventsSortData.OPENWEBINAR);
        log.info("Проверили отображение мероприятий с пометкой Открытый вебинар");
